...
void draw_static_petal_single(PetalID::T id, Renderer &ctx) {
    ...
    switch(id.type) {
        ...
        case PetalType::kLightning: {
            ...
            ctx.begin_path();
            ctx.move_to(5, 0);
            ctx.line_to(9.51, 3.09); ctx.line_to(4.05, 2.94); ctx.line_to(5.88, 8.09);
            ctx.line_to(1.55, 4.76); ctx.line_to(0, 10); ctx.line_to(-1.55, 4.76);
            ctx.line_to(-5.88, 8.09); ctx.line_to(-4.05, 2.94); ctx.line_to(-9.51, 3.09);
            ctx.line_to(-5, 0); ctx.line_to(-9.51, -3.09); ctx.line_to(-4.05, -2.94);
            ctx.line_to(-5.88, -8.09); ctx.line_to(-1.55, -4.76); ctx.line_to(0, -10);
            ctx.line_to(1.55, -4.76); ctx.line_to(5.88, -8.09); ctx.line_to(4.05, -2.94);
            ctx.line_to(9.51, -3.09); ctx.line_to(5, 0);
            ctx.fill(1);
            ctx.set_fill(0xff21c4b9);
            ctx.begin_path();
            ctx.move_to(5.28, -0.41); ctx.line_to(11.19, 3.64); ctx.line_to(4.03, 3.44);
            ctx.line_to(4.05, 2.94); ctx.line_to(4.52, 2.77); ctx.line_to(6.92, 9.52);
            ctx.line_to(1.24, 5.15); ctx.line_to(1.55, 4.76); ctx.line_to(2.02, 4.9);
            ctx.line_to(0, 11.77); ctx.line_to(-2.02, 4.9); ctx.line_to(-1.55, 4.76);
            ctx.line_to(-1.24, 5.15); ctx.line_to(-6.92, 9.52); ctx.line_to(-4.52, 2.77);
            ctx.line_to(-4.05, 2.94); ctx.line_to(-4.03, 3.44); ctx.line_to(-11.19, 3.64);
            ctx.line_to(-5.28, -0.41); ctx.line_to(-5, 0); ctx.line_to(-5.28, 0.41);
            ctx.line_to(-11.19, -3.64); ctx.line_to(-4.03, -3.44); ctx.line_to(-4.05, -2.94);
            ctx.line_to(-4.52, -2.77); ctx.line_to(-6.92, -9.52); ctx.line_to(-1.24, -5.15);
            ctx.line_to(-1.55, -4.76); ctx.line_to(-2.02, -4.9); ctx.line_to(0, -11.77);
            ctx.line_to(2.02, -4.9); ctx.line_to(1.55, -4.76); ctx.line_to(1.24, -5.15);
            ctx.line_to(6.92, -9.52); ctx.line_to(4.52, -2.77); ctx.line_to(4.05, -2.94);
            ctx.line_to(4.03, -3.44); ctx.line_to(11.19, -3.64); ctx.line_to(5.28, 0.41);
            ctx.line_to(5, 0); ctx.line_to(5.28, -0.41);
            ctx.move_to(4.12, 0);
            ctx.line_to(9.23, -3.5); ctx.line_to(9.51, -3.09); ctx.line_to(9.52, -2.59); ctx.line_to(3.33, -2.42);
            ctx.line_to(5.41, -8.26); ctx.line_to(5.88, -8.09); ctx.line_to(6.18, -7.69); ctx.line_to(1.27, -3.91);
            ctx.line_to(-0.48, -9.86); ctx.line_to(0, -10); ctx.line_to(0.48, -9.86); ctx.line_to(-1.27, -3.91);
            ctx.line_to(-6.18, -7.69); ctx.line_to(-5.88, -8.09); ctx.line_to(-5.41, -8.26); ctx.line_to(-3.33, -2.42);
            ctx.line_to(-9.52, -2.59); ctx.line_to(-9.51, -3.09); ctx.line_to(-9.23, -3.5); ctx.line_to(-4.12, 0);
            ctx.line_to(-9.23, 3.5); ctx.line_to(-9.51, 3.09); ctx.line_to(-9.52, 2.59); ctx.line_to(-3.33, 2.42);
            ctx.line_to(-5.41, 8.26); ctx.line_to(-5.88, 8.09); ctx.line_to(-6.18, 7.69); ctx.line_to(-1.27, 3.91);
            ctx.line_to(0.48, 9.86); ctx.line_to(0, 10); ctx.line_to(-0.48, 9.86); ctx.line_to(1.27, 3.91);
            ctx.line_to(6.18, 7.69); ctx.line_to(5.88, 8.09); ctx.line_to(5.41, 8.26); ctx.line_to(3.33, 2.42);
            ctx.line_to(9.52, 2.59); ctx.line_to(9.51, 3.09); ctx.line_to(9.23, 3.5); ctx.line_to(4.72, 0.41);
            ctx.line_to(4.12, 0);
            ctx.fill(1);
            break;
        }
        case PetalType::kClaw: {
            RenderContext _c(&ctx);
            ctx.scale(r / 10.0f);
            ctx.round_line_join();
            ...
            ctx.begin_path();
            ctx.move_to(-14, -4);
            ctx.qcurve_to(8, -16, 18, 6);
            ctx.line_to(8, 0);
            ctx.line_to(12, 10);
            ctx.qcurve_to(-2, -2, -14, 4);
            ctx.qcurve_to(-12, 0, -14, -4);
            ctx.fill(1);
            ctx.set_fill(0xff3e1f1b);
            ctx.begin_path();
            ctx.move_to(-14.96, -5.76);
            ctx.qcurve_to(-3.21, -12.16, 5.6, -9.41);
            ctx.qcurve_to(14.45, -6.64, 19.82, 5.17);
            ctx.qcurve_to(20.16, 5.93, 19.87, 6.7);
            ctx.qcurve_to(19.58, 7.48, 18.83, 7.82);
            ctx.qcurve_to(18.38, 8.02, 17.89, 8);
            ctx.qcurve_to(17.39, 7.97, 16.97, 7.71);
            ctx.line_to(6.97, 1.71); ctx.line_to(8, 0); ctx.line_to(9.86, -0.74);
            ctx.line_to(13.86, 9.26);
            ctx.qcurve_to(14.16, 10.03, 13.84, 10.79);
            ctx.qcurve_to(13.51, 11.55, 12.74, 11.86);
            ctx.qcurve_to(12.22, 12.06, 11.67, 11.97);
            ctx.qcurve_to(11.12, 11.88, 10.7, 11.52);
            ctx.qcurve_to(-2.29, 0.38, -13.11, 5.79);
            ctx.qcurve_to(-13.85, 6.16, -14.63, 5.9);
            ctx.qcurve_to(-15.42, 5.64, -15.79, 4.89);
            ctx.qcurve_to(-16, 4.47, -16, 4);
            ctx.qcurve_to(-16, 3.53, -15.79, 3.11);
            ctx.qcurve_to(-14.24, 0, -15.79, -3.11);
            ctx.qcurve_to(-16.15, -3.83, -15.91, -4.6);
            ctx.qcurve_to(-15.67, -5.37, -14.96, -5.76);
            ctx.move_to(-13.04, -2.24); ctx.line_to(-14, -4); ctx.line_to(-12.21, -4.89);
            ctx.qcurve_to(-9.76, 0, -12.21, 4.89);
            ctx.line_to(-14, 4); ctx.line_to(-14.89, 2.21);
            ctx.qcurve_to(-1.71, -4.38, 13.3, 8.48);
            ctx.line_to(12, 10); ctx.line_to(10.14, 10.74); ctx.line_to(6.14, 0.74);
            ctx.qcurve_to(5.97, 0.31, 6.01, -0.16);
            ctx.qcurve_to(6.04, -0.63, 6.29, -1.03);
            ctx.qcurve_to(6.71, -1.74, 7.51, -1.94);
            ctx.qcurve_to(8.32, -2.14, 9.03, -1.71);
            ctx.line_to(19.03, 4.29); ctx.line_to(18, 6); ctx.line_to(16.18, 6.83);
            ctx.qcurve_to(11.55, -3.36, 4.4, -5.59);
            ctx.qcurve_to(-2.79, -7.84, -13.04, -2.24);
            ctx.fill(1);
            break;
        }
        case PetalType::kFang: {
            RenderContext _c(&ctx);
            ctx.scale(r / 10.0f);
            ctx.round_line_join();
            ctx.set_fill(0xff9c1010);
            ctx.begin_path();
            ctx.move_to(13, 0);
            ctx.line_to(4.95, 4.95);
            ctx.qcurve_to(2.9, 7, 0, 7);
            ctx.qcurve_to(-2.9, 7, -4.95, 4.95);
            ctx.line_to(-13, 0);
            ctx.line_to(-4.95, -4.95);
            ctx.qcurve_to(-2.9, -7, 0, -7);
            ctx.qcurve_to(2.9, -7, 4.95, -4.95);
            ctx.line_to(13, 0);
            ctx.fill(1);
            ctx.set_fill(0xff7e0d0d);
            ctx.begin_path();
            ctx.move_to(13.79, 1.28); ctx.line_to(5.74, 6.23); ctx.line_to(4.95, 4.95);
            ctx.line_to(6.01, 6.01);
            ctx.qcurve_to(3.52, 8.5, 0, 8.5);
            ctx.qcurve_to(-3.52, 8.5, -6.01, 6.01);
            ctx.line_to(-4.95, 4.95); ctx.line_to(-5.74, 6.23); ctx.line_to(-13.79, 1.28);
            ctx.qcurve_to(-14.31, 0.95, -14.46, 0.35);
            ctx.qcurve_to(-14.6, -0.26, -14.28, -0.79);
            ctx.qcurve_to(-14.19, -0.94, -14.06, -1.06);
            ctx.qcurve_to(-13.94, -1.19, -13.79, -1.28);
            ctx.line_to(-5.74, -6.23); ctx.line_to(-4.95, -4.95); ctx.line_to(-6.01, -6.01);
            ctx.qcurve_to(-3.52, -8.5, 0, -8.5);
            ctx.qcurve_to(3.52, -8.5, 6.01, -6.01);
            ctx.line_to(4.95, -4.95); ctx.line_to(5.74, -6.23); ctx.line_to(13.79, -1.28);
            ctx.qcurve_to(14.31, -0.95, 14.46, -0.35);
            ...
            ctx.qcurve_to(14.19, 0.94, 14.06, 1.06);
            ctx.qcurve_to(13.94, 1.19, 13.79, 1.28);
            ctx.move_to(12.21, -1.28); ctx.line_to(13, 0); ctx.line_to(12.21, 1.28);
            ctx.line_to(4.16, -3.67);
            ctx.qcurve_to(4.09, -3.72, 4.02, -3.77);
            ctx.qcurve_to(3.95, -3.83, 3.89, -3.89);
            ctx.qcurve_to(2.28, -5.5, 0, -5.5);
            ctx.qcurve_to(-2.28, -5.5, -3.89, -3.89);
            ctx.qcurve_to(-3.95, -3.83, -4.02, -3.77);
            ctx.qcurve_to(-4.09, -3.72, -4.16, -3.67);
            ctx.line_to(-12.21, 1.28); ctx.line_to(-13, 0); ctx.line_to(-12.21, -1.28);
            ctx.line_to(-4.16, 3.67);
            ctx.qcurve_to(-4.09, 3.72, -4.02, 3.77);
            ctx.qcurve_to(-3.95, 3.83, -3.89, 3.89);
            ctx.qcurve_to(-2.28, 5.5, 0, 5.5);
            ...
            ctx.qcurve_to(3.95, 3.83, 4.02, 3.77);
            ctx.qcurve_to(4.09, 3.72, 4.16, 3.67);
            ctx.line_to(12.21, -1.28);
            ctx.fill(1);
            break;
        }
        case PetalType::kMagnet: {
            RenderContext _c(&ctx);
            ctx.scale(r / 18.0f);
            ctx.round_line_join();
            ctx.round_line_cap();
