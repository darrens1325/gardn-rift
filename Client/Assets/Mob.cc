...
void draw_static_mob(MobID::T mob_id, Renderer &ctx, MobRenderAttributes attr) {
    ...
    switch(mob_id) {
        ...
        case MobID::kWasp:
            ...
            ctx.qcurve_to(-20.353, 2.329, -15.229, 4.658);
            ctx.qcurve_to(-15.229, 0.000, -15.229, -4.658);
            ctx.qcurve_to(-20.353, -2.329, -25.477, 0.000);
            ctx.fill();

            ctx.set_fill(0xff333333);
            ctx.begin_path();
            ctx.move_to(-24.996, -1.060);
            ctx.qcurve_to(-19.871, 1.269, -14.747, 3.598);
            ctx.qcurve_to(-14.988, 4.128, -15.229, 4.658);
            ctx.qcurve_to(-15.812, 4.658, -16.394, 4.658);
            ctx.qcurve_to(-16.394, 0.000, -16.394, -4.658);
            ctx.qcurve_to(-15.812, -4.658, -15.229, -4.658);
            ctx.qcurve_to(-14.988, -4.128, -14.747, -3.598);
            ctx.qcurve_to(-19.871, -1.269, -24.996, 1.060);
            ctx.qcurve_to(-25.237, 0.530, -25.478, 0.000);
            ctx.qcurve_to(-25.237, -0.530, -24.996, -1.060);
            ctx.fill();
            ctx.begin_path();
            ctx.move_to(-25.959, 1.060);
            ctx.qcurve_to(-26.055, 1.017, -26.141, 0.957);
            ctx.qcurve_to(-26.227, 0.897, -26.301, 0.823);
            ctx.qcurve_to(-26.375, 0.749, -26.435, 0.663);
            ctx.qcurve_to(-26.494, 0.577, -26.537, 0.482);
            ctx.qcurve_to(-26.561, 0.430, -26.580, 0.376);
            ctx.qcurve_to(-26.598, 0.321, -26.611, 0.266);
            ctx.qcurve_to(-26.624, 0.210, -26.632, 0.153);
            ctx.qcurve_to(-26.640, 0.097, -26.641, 0.040);
            ctx.qcurve_to(-26.643, -0.018, -26.640, -0.074);
            ctx.qcurve_to(-26.637, -0.131, -26.627, -0.189);
            ctx.qcurve_to(-26.617, -0.245, -26.603, -0.300);
            ctx.qcurve_to(-26.588, -0.355, -26.568, -0.409);
            ctx.qcurve_to(-26.548, -0.462, -26.523, -0.514);
            ctx.qcurve_to(-26.498, -0.565, -26.467, -0.614);
            ctx.qcurve_to(-26.437, -0.663, -26.402, -0.708);
            ctx.qcurve_to(-26.367, -0.753, -26.329, -0.795);
            ctx.qcurve_to(-26.290, -0.837, -26.246, -0.875);
            ctx.qcurve_to(-26.203, -0.912, -26.157, -0.946);
            ctx.qcurve_to(-26.110, -0.979, -26.061, -1.008);
            ctx.qcurve_to(-26.012, -1.037, -25.959, -1.060);
            ctx.qcurve_to(-20.835, -3.389, -15.711, -5.719);
            ctx.qcurve_to(-15.481, -5.823, -15.229, -5.823);
            ctx.qcurve_to(-15.172, -5.823, -15.115, -5.818);
            ctx.qcurve_to(-15.058, -5.812, -15.002, -5.800);
            ctx.qcurve_to(-14.946, -5.789, -14.891, -5.773);
            ctx.qcurve_to(-14.836, -5.756, -14.784, -5.734);
            ctx.qcurve_to(-14.731, -5.712, -14.680, -5.686);
            ctx.qcurve_to(-14.630, -5.659, -14.582, -5.627);
            ctx.qcurve_to(-14.535, -5.594, -14.490, -5.559);
            ctx.qcurve_to(-14.446, -5.522, -14.406, -5.482);
            ctx.qcurve_to(-14.365, -5.441, -14.329, -5.397);
            ctx.qcurve_to(-14.293, -5.353, -14.261, -5.305);
            ctx.qcurve_to(-14.229, -5.258, -14.202, -5.207);
            ctx.qcurve_to(-14.175, -5.157, -14.153, -5.104);
            ctx.qcurve_to(-14.131, -5.051, -14.115, -4.997);
            ctx.qcurve_to(-14.098, -4.942, -14.087, -4.886);
            ctx.qcurve_to(-14.076, -4.829, -14.070, -4.772);
            ctx.qcurve_to(-14.064, -4.716, -14.065, -4.658);
            ctx.qcurve_to(-14.065, -0.000, -14.064, 4.658);
            ctx.qcurve_to(-14.064, 4.911, -14.169, 5.140);
            ctx.qcurve_to(-14.192, 5.192, -14.221, 5.242);
            ctx.qcurve_to(-14.250, 5.291, -14.283, 5.338);
            ctx.qcurve_to(-14.317, 5.384, -14.354, 5.427);
            ctx.qcurve_to(-14.392, 5.471, -14.434, 5.509);
            ctx.qcurve_to(-14.476, 5.548, -14.521, 5.583);
            ctx.qcurve_to(-14.566, 5.618, -14.615, 5.648);
            ctx.qcurve_to(-14.665, 5.679, -14.715, 5.703);
            ctx.qcurve_to(-14.766, 5.728, -14.820, 5.749);
            ctx.qcurve_to(-14.874, 5.770, -14.929, 5.784);
            ctx.qcurve_to(-14.984, 5.798, -15.041, 5.808);
            ctx.qcurve_to(-15.097, 5.818, -15.154, 5.821);
            ctx.qcurve_to(-15.212, 5.823, -15.268, 5.822);
            ctx.qcurve_to(-15.325, 5.821, -15.382, 5.813);
            ctx.qcurve_to(-15.440, 5.804, -15.495, 5.792);
            ctx.qcurve_to(-15.550, 5.779, -15.605, 5.761);
            ctx.qcurve_to(-15.659, 5.742, -15.711, 5.719);
            ctx.qcurve_to(-20.835, 3.389, -25.959, 1.060);
            ctx.fill();

            ctx.set_fill(0xffc8803c);
            ctx.begin_path();
            ctx.move_to(10.391, -0.000);
            ctx.qcurve_to(10.391, 0.229, 10.375, 0.457);
            ctx.qcurve_to(10.358, 0.685, 10.324, 0.913);
            ctx.qcurve_to(10.290, 1.141, 10.241, 1.367);
            ctx.qcurve_to(10.191, 1.593, 10.123, 1.818);
            ctx.qcurve_to(10.056, 2.042, 9.973, 2.264);
            ctx.qcurve_to(9.890, 2.485, 9.790, 2.705);
            ctx.qcurve_to(9.690, 2.924, 9.575, 3.138);
            ctx.qcurve_to(9.460, 3.353, 9.328, 3.565);
            ctx.qcurve_to(9.196, 3.778, 9.050, 3.983);
            ctx.qcurve_to(8.903, 4.190, 8.741, 4.392);
            ctx.qcurve_to(8.580, 4.594, 8.403, 4.790);
            ctx.qcurve_to(8.227, 4.986, 8.037, 5.176);
            ctx.qcurve_to(7.846, 5.366, 7.641, 5.550);
            ctx.qcurve_to(7.437, 5.734, 7.220, 5.911);
            ctx.qcurve_to(7.002, 6.087, 6.771, 6.257);
            ctx.qcurve_to(6.541, 6.427, 6.299, 6.588);
            ctx.qcurve_to(6.056, 6.749, 5.802, 6.903);
            ctx.qcurve_to(5.547, 7.057, 5.282, 7.202);
            ctx.qcurve_to(5.017, 7.347, 4.742, 7.483);
            ctx.qcurve_to(4.466, 7.619, 4.180, 7.746);
            ctx.qcurve_to(3.895, 7.874, 3.601, 7.991);
            ctx.qcurve_to(3.307, 8.109, 3.005, 8.217);
            ctx.qcurve_to(2.702, 8.325, 2.392, 8.422);
            ctx.qcurve_to(2.081, 8.520, 1.764, 8.608);
            ctx.qcurve_to(1.448, 8.695, 1.125, 8.772);
            ctx.qcurve_to(0.802, 8.849, 0.473, 8.916);
            ctx.qcurve_to(0.144, 8.982, -0.188, 9.037);
            ctx.qcurve_to(-0.521, 9.093, -0.857, 9.137);
            ctx.qcurve_to(-1.193, 9.182, -1.533, 9.216);
            ctx.qcurve_to(-1.872, 9.249, -2.214, 9.272);
            ctx.qcurve_to(-2.555, 9.294, -2.898, 9.305);
            ctx.qcurve_to(-3.240, 9.317, -3.583, 9.317);
            ctx.qcurve_to(-3.926, 9.317, -4.269, 9.306);
            ctx.qcurve_to(-4.612, 9.294, -4.953, 9.272);
            ctx.qcurve_to(-5.295, 9.249, -5.634, 9.216);
            ctx.qcurve_to(-5.973, 9.182, -6.310, 9.137);
            ctx.qcurve_to(-6.646, 9.093, -6.979, 9.037);
            ctx.qcurve_to(-7.312, 8.982, -7.640, 8.916);
            ctx.qcurve_to(-7.969, 8.849, -8.292, 8.772);
            ctx.qcurve_to(-8.614, 8.695, -8.931, 8.607);
            ctx.qcurve_to(-9.248, 8.520, -9.559, 8.422);
            ctx.qcurve_to(-9.869, 8.325, -10.171, 8.217);
            ctx.qcurve_to(-10.474, 8.109, -10.768, 7.991);
            ctx.qcurve_to(-11.062, 7.874, -11.347, 7.746);
            ctx.qcurve_to(-11.632, 7.619, -11.908, 7.483);
            ctx.qcurve_to(-12.184, 7.347, -12.449, 7.202);
            ctx.qcurve_to(-12.714, 7.057, -12.969, 6.903);
            ctx.qcurve_to(-13.223, 6.750, -13.465, 6.588);
            ctx.qcurve_to(-13.707, 6.426, -13.938, 6.257);
            ctx.qcurve_to(-14.168, 6.087, -14.386, 5.910);
            ctx.qcurve_to(-14.604, 5.734, -14.808, 5.550);
            ctx.qcurve_to(-15.013, 5.366, -15.203, 5.176);
            ctx.qcurve_to(-15.393, 4.986, -15.570, 4.789);
            ctx.qcurve_to(-15.746, 4.594, -15.908, 4.392);
            ctx.qcurve_to(-16.070, 4.190, -16.217, 3.983);
            ctx.qcurve_to(-16.363, 3.776, -16.495, 3.566);
            ctx.qcurve_to(-16.626, 3.354, -16.742, 3.139);
            ctx.qcurve_to(-16.857, 2.923, -16.957, 2.705);
            ctx.qcurve_to(-17.056, 2.486, -17.139, 2.264);
            ctx.qcurve_to(-17.223, 2.042, -17.290, 1.818);
            ctx.qcurve_to(-17.357, 1.594, -17.407, 1.367);
            ctx.qcurve_to(-17.457, 1.141, -17.491, 0.913);
            ctx.qcurve_to(-17.525, 0.685, -17.542, 0.457);
            ctx.qcurve_to(-17.559, 0.229, -17.559, 0.000);
            ctx.qcurve_to(-17.559, -0.229, -17.542, -0.457);
            ctx.qcurve_to(-17.525, -0.685, -17.491, -0.913);
            ctx.qcurve_to(-17.458, -1.141, -17.407, -1.367);
            ctx.qcurve_to(-17.357, -1.594, -17.290, -1.818);
            ctx.qcurve_to(-17.223, -2.042, -17.140, -2.263);
            ctx.qcurve_to(-17.057, -2.485, -16.957, -2.704);
            ctx.qcurve_to(-16.857, -2.923, -16.741, -3.138);
            ctx.qcurve_to(-16.626, -3.353, -16.494, -3.565);
            ctx.qcurve_to(-16.363, -3.777, -16.217, -3.983);
            ctx.qcurve_to(-16.070, -4.190, -15.908, -4.392);
            ctx.qcurve_to(-15.746, -4.594, -15.570, -4.790);
            ctx.qcurve_to(-15.394, -4.986, -15.203, -5.176);
            ctx.qcurve_to(-15.013, -5.366, -14.808, -5.550);
            ctx.qcurve_to(-14.604, -5.734, -14.386, -5.910);
            ctx.qcurve_to(-14.168, -6.087, -13.938, -6.257);
            ctx.qcurve_to(-13.708, -6.426, -13.465, -6.588);
            ctx.qcurve_to(-13.222, -6.750, -12.969, -6.903);
            ctx.qcurve_to(-12.714, -7.057, -12.449, -7.202);
            ctx.qcurve_to(-12.184, -7.347, -11.908, -7.483);
            ctx.qcurve_to(-11.632, -7.619, -11.347, -7.746);
            ctx.qcurve_to(-11.062, -7.874, -10.768, -7.991);
            ctx.qcurve_to(-10.474, -8.109, -10.171, -8.217);
            ctx.qcurve_to(-9.869, -8.325, -9.559, -8.422);
            ctx.qcurve_to(-9.248, -8.520, -8.931, -8.607);
            ctx.qcurve_to(-8.614, -8.695, -8.292, -8.772);
            ctx.qcurve_to(-7.968, -8.849, -7.640, -8.916);
            ctx.qcurve_to(-7.312, -8.982, -6.979, -9.037);
            ctx.qcurve_to(-6.646, -9.093, -6.310, -9.137);
            ctx.qcurve_to(-5.973, -9.182, -5.634, -9.216);
            ctx.qcurve_to(-5.295, -9.249, -4.953, -9.272);
            ctx.qcurve_to(-4.612, -9.294, -4.269, -9.305);
            ctx.qcurve_to(-3.926, -9.317, -3.583, -9.317);
            ctx.qcurve_to(-3.240, -9.317, -2.897, -9.306);
            ctx.qcurve_to(-2.555, -9.294, -2.214, -9.272);
            ctx.qcurve_to(-1.872, -9.250, -1.533, -9.216);
            ctx.qcurve_to(-1.193, -9.182, -0.857, -9.137);
            ctx.qcurve_to(-0.521, -9.093, -0.188, -9.037);
            ctx.qcurve_to(0.145, -8.982, 0.473, -8.916);
            ctx.qcurve_to(0.802, -8.849, 1.125, -8.772);
            ctx.qcurve_to(1.448, -8.695, 1.764, -8.608);
            ctx.qcurve_to(2.082, -8.520, 2.392, -8.422);
            ctx.qcurve_to(2.702, -8.324, 3.005, -8.217);
            ctx.qcurve_to(3.307, -8.109, 3.601, -7.991);
            ctx.qcurve_to(3.895, -7.874, 4.180, -7.746);
            ctx.qcurve_to(4.466, -7.619, 4.741, -7.483);
            ctx.qcurve_to(5.017, -7.347, 5.282, -7.202);
            ctx.qcurve_to(5.548, -7.057, 5.802, -6.903);
            ctx.qcurve_to(6.056, -6.750, 6.299, -6.588);
            ctx.qcurve_to(6.541, -6.426, 6.771, -6.257);
            ctx.qcurve_to(7.001, -6.088, 7.220, -5.910);
            ctx.qcurve_to(7.438, -5.733, 7.641, -5.550);
            ctx.qcurve_to(7.845, -5.367, 8.037, -5.176);
            ctx.qcurve_to(8.228, -4.985, 8.403, -4.790);
            ctx.qcurve_to(8.578, -4.595, 8.741, -4.392);
            ctx.qcurve_to(8.904, -4.190, 9.050, -3.983);
            ctx.qcurve_to(9.196, -3.777, 9.328, -3.565);
            ctx.qcurve_to(9.459, -3.354, 9.575, -3.138);
            ctx.qcurve_to(9.690, -2.923, 9.790, -2.705);
            ctx.qcurve_to(9.889, -2.486, 9.973, -2.264);
            ctx.qcurve_to(10.056, -2.042, 10.123, -1.818);
            ctx.qcurve_to(10.190, -1.593, 10.241, -1.367);
            ctx.qcurve_to(10.290, -1.141, 10.324, -0.913);
            ctx.qcurve_to(10.358, -0.685, 10.375, -0.457);
            ctx.qcurve_to(10.391, -0.229, 10.392, 0.000);
            ctx.fill();

            ctx.set_fill(0xff333333);
            ctx.begin_path();
            ctx.move_to(2.903, -8.253);
            ctx.qcurve_to(-0.753, -0.000, 2.903, 8.253);
            ctx.qcurve_to(1.911, 8.599, 0.850, 8.836);
            ctx.qcurve_to(-0.211, 9.072, -1.316, 9.193);
            ctx.qcurve_to(-5.851, -0.001, -1.315, -9.193);
            ctx.qcurve_to(-0.211, -9.072, 0.850, -8.835);
            ctx.qcurve_to(1.912, -8.598, 2.903, -8.252);
            ctx.fill();
            ctx.begin_path();
            ctx.move_to(-11.277, -7.777);
            ctx.qcurve_to(-10.851, -7.964, -10.407, -8.130);
            ctx.qcurve_to(-9.962, -8.296, -9.501, -8.440);
            ctx.qcurve_to(-9.039, -8.583, -8.563, -8.705);
            ctx.qcurve_to(-8.087, -8.826, -7.599, -8.923);
            ctx.qcurve_to(-7.111, -9.021, -6.614, -9.095);
            ctx.qcurve_to(-6.118, -9.169, -5.612, -9.218);
            ctx.qcurve_to(-5.109, -9.267, -4.601, -9.292);
            ctx.qcurve_to(-4.093, -9.316, -3.583, -9.316);
            ctx.qcurve_to(-8.241, -0.000, -3.583, 9.317);
            ctx.qcurve_to(-4.093, 9.317, -4.601, 9.292);
            ctx.qcurve_to(-5.109, 9.268, -5.613, 9.218);
            ctx.qcurve_to(-6.116, 9.169, -6.614, 9.095);
            ctx.qcurve_to(-7.112, 9.022, -7.599, 8.924);
            ctx.qcurve_to(-8.086, 8.826, -8.563, 8.705);
            ctx.qcurve_to(-9.040, 8.585, -9.501, 8.441);
            ctx.qcurve_to(-9.962, 8.296, -10.407, 8.130);
            ctx.qcurve_to(-10.851, 7.965, -11.277, 7.778);
            ctx.qcurve_to(-14.523, 0.000, -11.277, -7.777);
            ctx.fill();

            ctx.set_fill(0xffb77334);
            ctx.begin_path();
            ctx.move_to(11.556, -0.000);
            ctx.qcurve_to(11.556, 4.482, 6.945, 7.557);
            ctx.qcurve_to(2.558, 10.481, -3.583, 10.481);
            ctx.qcurve_to(-9.725, 10.481, -14.111, 7.557);
            ctx.qcurve_to(-18.723, 4.482, -18.723, 0.000);
            ctx.qcurve_to(-18.723, -4.482, -14.112, -7.557);
            ctx.qcurve_to(-9.725, -10.481, -3.583, -10.481);
            ctx.qcurve_to(2.558, -10.481, 6.944, -7.557);
            ctx.qcurve_to(11.556, -4.482, 11.556, 0.000);
            ctx.qcurve_to(11.556, 0.057, 11.551, 0.114);
            ctx.qcurve_to(11.545, 0.171, 11.534, 0.227);
            ctx.qcurve_to(11.522, 0.284, 11.506, 0.338);
            ctx.qcurve_to(11.490, 0.393, 11.468, 0.446);
            ctx.qcurve_to(11.446, 0.498, 11.419, 0.549);
            ctx.qcurve_to(11.392, 0.600, 11.360, 0.647);
            ctx.qcurve_to(11.329, 0.694, 11.292, 0.739);
            ctx.qcurve_to(11.256, 0.783, 11.215, 0.824);
            ctx.qcurve_to(11.175, 0.864, 11.131, 0.900);
            ctx.qcurve_to(11.086, 0.936, 11.038, 0.968);
            ctx.qcurve_to(10.990, 1.000, 10.941, 1.027);
            ctx.qcurve_to(10.890, 1.054, 10.837, 1.076);
            ctx.qcurve_to(10.784, 1.098, 10.730, 1.114);
            ctx.qcurve_to(10.675, 1.131, 10.619, 1.142);
            ctx.qcurve_to(10.562, 1.153, 10.506, 1.159);
            ctx.qcurve_to(10.449, 1.165, 10.391, 1.165);
            ctx.qcurve_to(10.334, 1.164, 10.278, 1.159);
            ctx.qcurve_to(10.222, 1.154, 10.164, 1.142);
            ctx.qcurve_to(10.109, 1.131, 10.054, 1.114);
            ctx.qcurve_to(9.999, 1.098, 9.946, 1.076);
            ctx.qcurve_to(9.893, 1.054, 9.843, 1.027);
            ctx.qcurve_to(9.792, 1.000, 9.745, 0.968);
            ctx.qcurve_to(9.697, 0.937, 9.653, 0.900);
            ctx.qcurve_to(9.608, 0.864, 9.568, 0.823);
            ctx.qcurve_to(9.528, 0.783, 9.491, 0.739);
            ctx.qcurve_to(9.455, 0.695, 9.423, 0.647);
            ctx.qcurve_to(9.391, 0.599, 9.365, 0.549);
            ctx.qcurve_to(9.338, 0.498, 9.316, 0.445);
            ctx.qcurve_to(9.294, 0.393, 9.277, 0.338);
            ctx.qcurve_to(9.261, 0.283, 9.249, 0.227);
            ctx.qcurve_to(9.238, 0.172, 9.233, 0.114);
            ctx.qcurve_to(9.227, 0.056, 9.227, 0.000);
            ctx.qcurve_to(9.227, -3.235, 5.652, -5.619);
            ctx.qcurve_to(1.853, -8.152, -3.583, -8.152);
            ctx.qcurve_to(-9.019, -8.152, -12.819, -5.619);
            ctx.qcurve_to(-16.394, -3.236, -16.393, 0.000);
            ctx.qcurve_to(-16.394, 3.236, -12.819, 5.619);
            ctx.qcurve_to(-9.019, 8.152, -3.583, 8.152);
            ctx.qcurve_to(1.853, 8.152, 5.652, 5.619);
            ctx.qcurve_to(9.227, 3.236, 9.227, -0.000);
            ctx.qcurve_to(9.227, -0.057, 9.233, -0.114);
            ctx.qcurve_to(9.238, -0.171, 9.249, -0.227);
            ctx.qcurve_to(9.261, -0.283, 9.277, -0.338);
            ctx.qcurve_to(9.294, -0.393, 9.316, -0.446);
            ctx.qcurve_to(9.338, -0.498, 9.364, -0.549);
            ctx.qcurve_to(9.392, -0.600, 9.423, -0.647);
            ctx.qcurve_to(9.455, -0.694, 9.491, -0.739);
            ctx.qcurve_to(9.528, -0.783, 9.568, -0.823);
            ctx.qcurve_to(9.608, -0.864, 9.653, -0.900);
            ctx.qcurve_to(9.698, -0.937, 9.745, -0.968);
            ctx.qcurve_to(9.792, -0.999, 9.843, -1.027);
            ctx.qcurve_to(9.893, -1.055, 9.946, -1.076);
            ctx.qcurve_to(9.999, -1.096, 10.054, -1.114);
            ctx.qcurve_to(10.108, -1.132, 10.164, -1.142);
            ctx.qcurve_to(10.220, -1.153, 10.278, -1.159);
            ctx.qcurve_to(10.334, -1.165, 10.391, -1.165);
            ctx.qcurve_to(10.449, -1.165, 10.506, -1.159);
            ctx.qcurve_to(10.563, -1.154, 10.619, -1.142);
            ctx.qcurve_to(10.675, -1.130, 10.730, -1.114);
            ctx.qcurve_to(10.785, -1.098, 10.837, -1.076);
            ctx.qcurve_to(10.890, -1.054, 10.941, -1.027);
            ctx.qcurve_to(10.991, -1.000, 11.039, -0.968);
            ctx.qcurve_to(11.086, -0.937, 11.131, -0.900);
            ctx.qcurve_to(11.175, -0.864, 11.215, -0.824);
            ctx.qcurve_to(11.256, -0.783, 11.292, -0.739);
            ctx.qcurve_to(11.329, -0.694, 11.360, -0.647);
            ctx.qcurve_to(11.391, -0.599, 11.419, -0.549);
            ctx.qcurve_to(11.446, -0.499, 11.467, -0.445);
            ctx.qcurve_to(11.488, -0.392, 11.506, -0.338);
            ctx.qcurve_to(11.524, -0.284, 11.534, -0.227);
            ctx.qcurve_to(11.545, -0.171, 11.551, -0.114);
            ctx.qcurve_to(11.556, -0.057, 11.556, -0.000);
            ctx.fill();

            ctx.set_fill(0xff333333);
            ctx.begin_path();
            ctx.move_to(7.842, -2.992);
            ctx.qcurve_to(7.790, -2.975, 7.741, -2.950);
            ctx.qcurve_to(7.693, -2.925, 7.649, -2.892);
            ctx.qcurve_to(7.604, -2.860, 7.566, -2.821);
            ctx.qcurve_to(7.528, -2.782, 7.496, -2.738);
            ctx.qcurve_to(7.464, -2.694, 7.439, -2.645);
            ctx.qcurve_to(7.415, -2.596, 7.398, -2.544);
            ctx.qcurve_to(7.381, -2.492, 7.372, -2.438);
            ctx.qcurve_to(7.363, -2.384, 7.364, -2.329);
            ctx.qcurve_to(7.364, -2.295, 7.367, -2.261);
            ctx.qcurve_to(7.371, -2.227, 7.377, -2.193);
            ctx.qcurve_to(7.384, -2.159, 7.394, -2.126);
            ctx.qcurve_to(7.404, -2.094, 7.417, -2.062);
            ctx.qcurve_to(7.430, -2.030, 7.446, -2.000);
            ctx.qcurve_to(7.462, -1.969, 7.482, -1.941);
            ctx.qcurve_to(7.500, -1.913, 7.522, -1.886);
            ctx.qcurve_to(7.544, -1.859, 7.569, -1.835);
            ctx.qcurve_to(7.593, -1.810, 7.619, -1.789);
            ctx.qcurve_to(7.645, -1.768, 7.674, -1.748);
            ctx.qcurve_to(7.704, -1.729, 7.733, -1.713);
            ctx.qcurve_to(7.763, -1.697, 7.795, -1.684);
            ctx.qcurve_to(7.828, -1.670, 7.860, -1.660);
            ctx.qcurve_to(7.891, -1.650, 7.926, -1.644);
            ctx.qcurve_to(7.960, -1.637, 7.994, -1.634);
            ctx.qcurve_to(8.028, -1.630, 8.062, -1.630);
            ctx.qcurve_to(15.290, -1.630, 23.864, -8.299);
            ctx.qcurve_to(23.912, -8.336, 23.952, -8.381);
            ctx.qcurve_to(23.992, -8.425, 24.025, -8.476);
            ctx.qcurve_to(24.057, -8.526, 24.080, -8.582);
            ctx.qcurve_to(24.103, -8.638, 24.116, -8.696);
            ctx.qcurve_to(24.130, -8.755, 24.133, -8.815);
            ctx.qcurve_to(24.136, -8.875, 24.129, -8.934);
            ctx.qcurve_to(24.121, -8.994, 24.104, -9.052);
            ctx.qcurve_to(24.087, -9.110, 24.060, -9.163);
            ctx.qcurve_to(24.045, -9.194, 24.026, -9.223);
            ctx.qcurve_to(24.008, -9.252, 23.987, -9.279);
            ctx.qcurve_to(23.966, -9.307, 23.942, -9.331);
            ctx.qcurve_to(23.919, -9.356, 23.893, -9.379);
            ctx.qcurve_to(23.867, -9.401, 23.839, -9.421);
            ctx.qcurve_to(23.811, -9.441, 23.781, -9.458);
            ctx.qcurve_to(23.752, -9.475, 23.720, -9.489);
            ctx.qcurve_to(23.688, -9.503, 23.656, -9.514);
            ctx.qcurve_to(23.624, -9.525, 23.590, -9.532);
            ctx.qcurve_to(23.556, -9.540, 23.523, -9.544);
            ctx.qcurve_to(23.488, -9.548, 23.454, -9.549);
            ctx.qcurve_to(23.420, -9.550, 23.386, -9.548);
            ctx.qcurve_to(23.351, -9.546, 23.317, -9.539);
            ctx.qcurve_to(23.283, -9.533, 23.251, -9.525);
            ctx.qcurve_to(23.218, -9.516, 23.185, -9.503);
            ctx.qcurve_to(23.153, -9.491, 23.123, -9.476);
